...
describe('GoogleSheetsService', () => {
  ...
  beforeEach(() => {
    ...
    (sheetsService as any)._sheets = mockSpreadsheets;
  });
  ...
  describe('getRandomChatMessage', () => {
    it('should return a random chat message', async () => {
      ...
      jest.spyOn(sheetsService, 'getValues').mockResolvedValue(mockMessages);
    ...
    it('should handle empty messages array', async () => {
      jest.spyOn(sheetsService, 'getValues').mockResolvedValue([]);
