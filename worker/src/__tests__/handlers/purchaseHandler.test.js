...
describe('PurchaseHandler', () => {
    ...
    beforeEach(() => {
        ...
        purchaseHandler = new purchaseHandler_1.PurchaseHandler(mockSheetsService, mockLineService);
    });
...
欲しい`;
            ...
            expect(mockSheetsService.setValues).toHaveBeenCalledWith('買い出しリスト', 'A2:B', [['オレンジ', ''], ['いちご', '']]);
        });
